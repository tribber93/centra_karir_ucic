            ...
            <div class="row">
                <div class="col-lg-5 col-12">
                    <div class="hero-header-content">
                        <p>Plan your life</p>
                        <h1>Increase your <b>productivity</b></h1>
                        <p>
                        ...
                        <div class="button">
                            <a href="https://www.youtube.com/watch?v=BqI0Q7e4kbk"
                                class="btn primary video-popup mfp-iframe">View video <i class="lni-play"></i></a>
                            <a href="#" class="btn btn-secondary">Get Start</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="single-work">
                        <div class="serial">
                            <span><i class="lni lni-folder"></i></span>
                        </div>
                        <h3>Files</h3>
                        <p>Lorem ipsum sit, consectetur adipiscing elit. Maecenas mi quam vulputate.</p>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-12">
                    <div class="info-media right">
                        <img src="img/service-img1.svg" alt="Desktop and Mobile App">
                    </div>
                </div>
                <div class="col-lg-5 col-12">
                    <div class="info-text">
                        <p class="short-title">Desktop and Mobile App</p>
                        <h2 class="main-title">Plan and Manage</h2>
                        <p class="des">Brute laoreet efficiendi id his, ea illum nonumes luptatum pro. Usu atqui
                            laudem an, insolens gubergren similique est cu. Et vel modus congue vituperata. Solum
                            patrioque no sea. Mea ex malis mollis oporteat. Eum an expetenda consequat.</p>
                        <div class="button">
                            <a href="https://www.youtube.com/watch?v=BqI0Q7e4kbk"
                                class="btn video-popup mfp-iframe">View video <i class="lni-play"></i></a>
                            <a href="#" class="btn btn-primary">See services</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-5 col-12">
                    <div class="info-text">
                        <p class="short-title">Desktop and Mobile App</p>
                        <h2 class="main-title">Build and Deploy</h2>
                        <p class="des">Brute laoreet efficiendi id his, ea illum nonumes luptatum pro. Usu atqui
                            laudem an, insolens gubergren similique est cu. Et vel modus congue vituperata. Solum
                            patrioque no sea. Mea ex malis mollis oporteat. Eum an expetenda consequat.</p>
                        <div class="button">
                ...
                <div class="col-lg-7 col-12">
                    <div class="info-media right">
                        <img src="img/service-img2.svg" alt="Desktop and Mobile App">
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-header" id="headingOne">
                                <h5 class="mb-0">
                                    <button class=" btn-link collapsed" data-toggle="collapse"
                                        ...
                                        <span class="arrow-container"></span> Reque insolens in vel?
                                    </button>
                                </h5>
                            </div>
                            ...
                            <div class="card-header" id="headingTwo">
                                <h5 class="mb-0">
                                    <button class=" btn-link" data-toggle="collapse" data-target="#collapseTwo"
                                        ...
                                        <span class="arrow-container"></span> Vis rebum error graecis ea, id sit postea
                                        accusamus?
                                    </button>
                                </h5>
                            </div>
                            ...
                            <div class="card-header" id="headingThree">
                                <h5 class="mb-0">
                                    <button class=" btn-link collapsed" data-toggle="collapse"
                                        ...
                                        <span class="arrow-container"></span> Lorem repudiandae ne nec?
                                    </button>
                                </h5>
                            </div>
