        ...
        <div class="container mt-5">
            <div class="box p-4">
                <div class="list-item mb-3">
                    <div class="list-left">
                        {{-- <img src="{{ asset('admin/css/images/a0.jpg') }}" class=""> --}}
                        ...
                        <div class="list-body">
                            <div class="row ">
                                ...
                                @if ($auth == $data->user->name)
                                    ...
                                    <button class="btn btn-success delete-button" data-comment-id="{{ $data->id }}"
                            ...
                            <button type="button" class="btn btn-primary save-edited-comment "
                                style="display: none ;margin-top:12px">Ubah</button>
                        </div>
                    </div>
                </div>
            @endforeach
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.save-edited-comment').click(function() {
                ...
                $(`.user-name[data-id="${commentId}"]`).closest('.list-body').find('.comment-content').text(
                    newComment).show();
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        $(`.user-name[data-id="${commentId}"]`).closest('.list-body').find('.comment-content')
                            .text(newComment).show();
