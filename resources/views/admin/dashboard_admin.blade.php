                ...
                <div class="box">
                    ...
                    <ul class="list no-border p-b">
                        <li class="list-item">
                            <a herf class="list-left">
                                <span class="w-40 avatar">
                                    <img src="../admin/css/images/a4.jpg" alt="...">
                        ...
                        <li class="list-item">
                            <a herf class="list-left">
                                <span class="w-40 avatar">
                                    <img src="../admin/css/images/a5.jpg" alt="...">
                                    <i class="on b-white bottom"></i>
                                </span>
                            </a>
                            <div class="list-body">
                        ...
                        <li class="list-item">
                            <a herf class="list-left">
                                <span class="w-40 avatar">
                                    <img src="../admin/css/images/a6.jpg" alt="...">
                        ...
                        <li class="list-item">
                            <a herf class="list-left">
                                <span class="w-40 avatar">
                                    <img src="../admin/css/images/a7.jpg" alt="...">
                            ...
                            <div class="sl-item b-success">
                                ...
                                <div class="sl-content">
                                    ...
                                    <div>Call to customer <a href class="text-info">Jacob</a> and discuss the
                                        detail about the AP project.</div>
                                </div>
                            </div>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="streamline b-l m-b m-l">
                            <div class="sl-item">
                                <div class="sl-left">
                                    <img src="../admin/css/images/a2.jpg" class="img-circle">
                                </div>
                                <div class="sl-content">
                                    <a href class="text-info">Louis Elliott</a><span class="m-l-sm sl-date">5
                                        min ago</span>
                            ...
                            <div class="sl-item">
                                <div class="sl-left">
                                    <img src="../admin/css/images/a5.jpg" class="img-circle">
                                </div>
                                <div class="sl-content">
                                    <a href class="text-info">Terry Moore</a><span class="m-l-sm sl-date">10
                                        min ago</span>
                            ...
                            <div class="sl-item">
                                <div class="sl-left">
                                    <img src="../admin/css/images/a8.jpg" class="img-circle">
                                </div>
                                <div class="sl-content">
                                    <a href class="text-info">Walter Paler</a><span class="m-l-sm sl-date">1
                                        hour ago</span>
